...
<form action="<?php echo e(asset('admin/video/proses_edit')); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
<div class="form-group row">
	...
	<div class="col-sm-9">
		<div class="form-group pull-right btn-group">
			...
			<a href="<?php echo e(asset('admin/video')); ?>" class="btn btn-danger">Kembali</a>
		</div>
	</div>
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/video/edit.blade.php ENDPATH**/ ?>