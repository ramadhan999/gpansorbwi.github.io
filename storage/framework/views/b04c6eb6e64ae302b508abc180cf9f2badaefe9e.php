...
<form action="<?php echo e(url('admin/heading/tambah')); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		<?php if($errors->has('judul_heading')): ?>
	      	<span class="text-danger"><?php echo e($errors->first('judul_heading')); ?></span>
	    <?php endif; ?>  
	</div>
</div>
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/heading/tambah.blade.php ENDPATH**/ ?>