...
<form action="<?php echo e(asset('admin/heading/edit')); ?>" enctype="multipart/form-data"  method="post" accept-charset="utf-8">
<?php echo e(csrf_field()); ?>

<input type="hidden" name="id_heading"   value="<?php echo e($heading->id_heading); ?>">
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<textarea name="keterangan" class="form-control simple" placeholder="Keterangan"><?php echo e($heading->keterangan); ?></textarea>
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/heading/edit.blade.php ENDPATH**/ ?>