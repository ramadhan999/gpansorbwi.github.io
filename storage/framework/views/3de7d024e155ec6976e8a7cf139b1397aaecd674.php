...
<form action="<?php echo e(asset('admin/konfigurasi/proses_profil')); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
<div class="row">
    ...
    <div class="row">
        <div class="form-group col-md-2">
            ...
            <img src="<?php echo e(asset('assets/upload/image/'.$site->gambar)); ?>" class="img img-thumbnail">
        </div>
...
<br><br>
</form><?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/konfigurasi/profil.blade.php ENDPATH**/ ?>