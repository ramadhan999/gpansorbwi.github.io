...
<div class="row">
  ...
  <div class="col-md-6">
    <form action="<?php echo e(asset('admin/agenda/cari')); ?>" method="get" accept-charset="utf-8">
    ...
    <div class="input-group">                  
      ...
      <span class="input-group-btn btn-flat">
        ...
        <?php if(Request::segment(3)=="jenis_agenda") { ?>
          <a href="<?php echo e(asset('admin/agenda/tambah?jenis_agenda='.Request::segment(4))); ?>" class="btn btn-success">
          <i class="fa fa-plus"></i> Tambah Baru</a>
        <?php }else{ ?>
          <a href="<?php echo e(asset('admin/agenda/tambah')); ?>" class="btn btn-success">
          <i class="fa fa-plus"></i> Tambah Baru</a>
        <?php } ?>
      </span>
    </div>
...
<form action="<?php echo e(asset('admin/agenda/proses')); ?>" method="post" accept-charset="utf-8">
...
<tr>
    <td class="text-center">
      <div class="icheck-primary">
        <input type="checkbox" name="id_agenda[]" value="<?php echo e($agenda->id_agenda); ?>" id="check<?php echo $i ?>">
        <label for="check<?php echo $i ?>"></label>
      </div>
    </td>
    <td class="text-center">
    <?php if($agenda->gambar!="") { ?>
      <img src="<?php echo e(asset('assets/upload/image/thumbs/'.$agenda->gambar)); ?>" class="img-thumbnail img-size-50 mr-2" >
      <?php }else{ ?>
      <img src="<?php echo e(asset('assets/upload/image/thumbs/'.website('icon'))); ?>" class="img-thumbnail img-size-50 mr-2" >
      <?php } ?>
    </td>
    <td>
    <a href="<?php echo e(asset('admin/agenda/edit/'.$agenda->id_agenda)); ?>">
    ...
    <td>
    <a href="<?php echo e(asset('admin/agenda/kategori_agenda/'.$agenda->id_kategori_agenda)); ?>">
    <?php echo $agenda->nama_kategori_agenda ?><sup><i class="fa fa-link"></i></sup>
    </a>
    <br>
    Jenis: <a href="<?php echo e(asset('admin/agenda/jenis_agenda/'.$agenda->jenis_agenda)); ?>">
    <?php echo $agenda->jenis_agenda ?><sup><i class="fa fa-link"></i></sup>
    </a></td>
    <td><a href="<?php echo e(asset('admin/agenda/status_agenda/'.$agenda->status_agenda)); ?>">
    ...
    <td>
    <a href="<?php echo e(asset('admin/agenda/author/'.$agenda->id_user)); ?>">
    <?php echo $agenda->nama ?><sup><i class="fa fa-link"></i></sup>
    </a></td>
    <td>
      <div class="btn-group">
        <a href="<?php echo e(asset('agenda/read/'.$agenda->slug_agenda)); ?>" 
        class="btn btn-success btn-sm" target="_blank"><i class="fa fa-eye"></i></a>

        <a href="<?php echo e(asset('admin/agenda/edit/'.$agenda->id_agenda)); ?>" 
        class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

        <a href="<?php echo e(asset('admin/agenda/delete/'.$agenda->id_agenda)); ?>" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
      </div>
    </td>
</tr>
...
</form><?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/agenda/index.blade.php ENDPATH**/ ?>