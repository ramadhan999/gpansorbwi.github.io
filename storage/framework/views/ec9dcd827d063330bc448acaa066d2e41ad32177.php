...
<!-- AdminLTE App -->
<!-- pace-progress -->
<script src="<?php echo e(asset('assets/admin/plugins/pace-progress/pace.min.js')); ?>"></script>
...
CKEDITOR.replace( 'kontenku',
      {
        filebrowserBrowseUrl : '<?php echo e(asset("assets/ckeditor/filemanager/dialog.php?type=2&editor=ckeditor&fldr=")); ?>',
        filebrowserUploadUrl : '<?php echo e(asset("assets/ckeditor/filemanager/dialog.php?type=2&editor=ckeditor&fldr=")); ?>',
        filebrowserImageBrowseUrl : '<?php echo e(asset("assets/ckeditor/filemanager/dialog.php?type=1&editor=ckeditor&fldr==")); ?>'
  } 
);
</script>
<!-- Page Script -->
...
</html><?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/layout/footer.blade.php ENDPATH**/ ?>