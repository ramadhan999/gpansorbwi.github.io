        ...
        <tbody>
          ...
          <?php $i=1; foreach($galeri as $galeri) { ?>
            ...
            <tr class="odd gradeX">
              ...
              <td><img src="<?php echo e(asset('assets/upload/image/thumbs/'.$galeri->gambar)); ?>" class="img img-thumbnail img-fluid"></td>
              ...
              <td><?php echo e($galeri->status_text); ?></td>
              <td>
                    <div class="btn-group">
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/galeri/index.blade.php ENDPATH**/ ?>