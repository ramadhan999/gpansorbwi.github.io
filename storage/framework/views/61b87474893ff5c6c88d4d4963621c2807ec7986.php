...
<div class="row">
  ...
  <div class="col-md-6">
    <form action="<?php echo e(asset('admin/berita/cari')); ?>" method="get" accept-charset="utf-8">
    ...
    <div class="input-group">                  
      ...
      <span class="input-group-btn btn-flat">
        ...
        <?php if(Request::segment(3)=="jenis_berita") { ?>
          <a href="<?php echo e(asset('admin/berita/tambah?jenis_berita='.Request::segment(4))); ?>" class="btn btn-success">
...
<tr>
    <td class="text-center">
      <div class="icheck-primary">
        <input type="checkbox" name="id_berita[]" value="<?php echo e($berita->id_berita); ?>" id="check<?php echo $i ?>">
        <label for="check<?php echo $i ?>"></label>
      </div>
    </td>
    <td class="text-center">
    <?php $site   = DB::table('konfigurasi')->first(); if($berita->gambar!="") { ?>
      <img src="<?php echo e(asset('assets/upload/image/thumbs/'.$berita->gambar)); ?>" class="img-thumbnail img-size-50 mr-2" >
      <?php }else{ ?>
    ...
    <?php echo $berita->judul_berita ?> <sup><i class="fa fa-pencil"></i></sup>
      ...
      <small>
        ...
        <br>Jenis: <a href="<?php echo e(asset('admin/berita/jenis_berita/'.$berita->jenis_berita)); ?>">
  ...
  <?php } ?>
    ...
    <td>
      <div class="btn-group">
        ...
        <a href="<?php echo e(asset('admin/berita/delete/'.$berita->id_berita.'/'.$berita->jenis_berita)); ?>" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
      </div>
    </td>
</tr>
...
</form><?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/berita/index.blade.php ENDPATH**/ ?>