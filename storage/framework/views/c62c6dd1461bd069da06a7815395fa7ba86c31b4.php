<p class="text-right">
  <a href="<?php echo e(asset('admin/berita')); ?>" class="btn btn-success btn-sm">
...
<form action="<?php echo e(asset('admin/berita/edit_proses')); ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
...
</div><?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/berita/edit.blade.php ENDPATH**/ ?>