<p class="text-right">
	<a href="<?php echo e(asset('admin/galeri')); ?>" class="btn btn-success btn-sm">
...
<form action="<?php echo e(asset('admin/galeri/edit_proses')); ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<?php echo e(csrf_field()); ?>

<input type="hidden" name="id_galeri" value="<?php echo e($galeri->id_galeri); ?>">
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/galeri/edit.blade.php ENDPATH**/ ?>