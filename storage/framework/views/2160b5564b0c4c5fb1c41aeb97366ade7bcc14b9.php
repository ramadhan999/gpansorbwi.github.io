...
<form action="<?php echo e(asset('admin/kategori_agenda/edit')); ?>" method="post" accept-charset="utf-8">
<?php echo e(csrf_field()); ?>

<input type="hidden" name="id_kategori_agenda" value="<?php echo e($kategori_agenda->id_kategori_agenda); ?>">
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<textarea name="keterangan" class="form-control" placeholder="Keterangan"><?php echo e($kategori_agenda->keterangan); ?></textarea>
	</div>
</div>
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/kategori_agenda/edit.blade.php ENDPATH**/ ?>