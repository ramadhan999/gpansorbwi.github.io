...
<form action="<?php echo e(asset('admin/konfigurasi/proses')); ?>" method="post" accept-charset="utf-8">
...
<div class="col-md-6">
    ...
    <input type="url" name="website" placeholder="<?php echo e(asset('/')); ?>" value="<?php echo $site->website ?>" class="form-control">
    </div>
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/konfigurasi/index.blade.php ENDPATH**/ ?>