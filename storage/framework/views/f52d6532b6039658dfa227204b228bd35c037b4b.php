...
<div class="row">
  ...
  <div class="col-md-6">
    <form action="<?php echo e(asset('admin/staff/cari')); ?>" method="get" accept-charset="utf-8">
    <br>
    <div class="input-group">                  
      ...
      <span class="input-group-btn btn-flat">
        ...
        <a href="<?php echo e(asset('admin/staff/tambah')); ?>" class="btn btn-success">
        ...
        <tbody>
          ...
          <?php $i=1; foreach($staff as $staff) { ?>
            ...
            <tr class="odd gradeX">
              ...
              <td><img src="<?php echo e(asset('assets/upload/staff/thumbs/'.$staff->gambar)); ?>" class="img img-thumbnail img-fluid" width="80"></td>
              ...
              <td><a href="<?php echo e(asset('admin/staff/kategori/'.$staff->id_kategori_staff)); ?>"><?php echo $staff->nama_kategori_staff ?></a></td>
              <td><a href="<?php echo e(asset('admin/staff/status_staff/'.$staff->status_staff)); ?>">
                  <?php echo $staff->status_staff ?></a></td>
              <td><?php echo $staff->urutan ?></td>
              <td><div class="btn-group">
                  <a href="<?php echo e(asset('admin/staff/detail/'.$staff->id_staff)); ?>" 
                  ...
                  <a href="<?php echo e(asset('admin/staff/edit/'.$staff->id_staff)); ?>" 
                    ...
                    <a href="<?php echo e(asset('admin/staff/delete/'.$staff->id_staff)); ?>" class="btn btn-danger btn-sm delete-link"><i class="fa fa-trash"></i></a>
                  </div>
                </td>
              </tr>
                    <?php $i++; } ?>
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/staff/index.blade.php ENDPATH**/ ?>