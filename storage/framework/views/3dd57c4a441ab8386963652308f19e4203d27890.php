...
<?php echo e(csrf_field()); ?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="file" name="gambar" class="form-control" placeholder="Cover Gambar" value="<?php echo e(old('gambar')); ?>">
					</div>
				</div>
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/video/tambah.blade.php ENDPATH**/ ?>