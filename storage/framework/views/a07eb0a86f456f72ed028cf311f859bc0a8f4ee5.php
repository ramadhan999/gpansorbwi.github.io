...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo e(asset('assets/upload/image/'.website('icon'))); ?>">
  ...
  <div class="card">
    <div class="card-body login-card-body">
    	<div class="login-logo">
		    <a href="<?php echo e('/'); ?>" style="color: orange;">
            <img src="<?php echo e(asset('assets/upload/image/'.website('logo'))); ?>" class="img img-responsive" style="width: auto; max-width: 50%;">
        </a>
		  </div>
      <div class="text-center">
          <hr>
        <h4><?php echo e(website('namaweb')); ?></h4>
          <p><?php echo e(website('tagline')); ?></p>
          <hr>
        </div>
      <p class="login-box-msg">Sign in to start your session</p>

      <form action="<?php echo e(asset('login/check')); ?>" method="post" accept-charset="utf-8">
      ...
      <p class="text-center link-bawah">
        <a href="<?php echo e(asset('/')); ?>">Back to Homepage</a> | <a href="<?php echo e(asset('login/forgot')); ?>">Forgot password?</a>
      </p>
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/login/index.blade.php ENDPATH**/ ?>