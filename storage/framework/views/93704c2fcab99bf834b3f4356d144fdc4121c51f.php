...
<form action="<?php echo e(url('admin/kategori/tambah')); ?>" method="post" accept-charset="utf-8">
...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		<?php if($errors->has('nama_kategori')): ?>
	      	<span class="text-danger"><?php echo e($errors->first('nama_kategori')); ?></span>
	    <?php endif; ?>  
	</div>
</div>
...
<?php /**PATH C:\xampp\htdocs\comprolaravel8\resources\views/admin/kategori/tambah.blade.php ENDPATH**/ ?>